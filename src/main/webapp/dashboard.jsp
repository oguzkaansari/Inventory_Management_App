        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="d-grid gap-2">
              ...
              <a href="order.jsp.jsp" class="btn btn-success btn-lg mb-2 text-left custom_btn button3" type="button"><i class="fa fa-shopping-cart"></i>  Sipariş Ekle</a>
            ...
            >
              <div class="card-body d-flex flex-row justify-content-between" style="padding-bottom: .6rem;">
                ...
                <div class="card-right">
                  <div style="font-size: 1.8rem;font-weight: 700; color:#22AE78;"><span id="cu_count"></span></div>
                </div>
              </div>
            </div>
            <div class="card mb-3">
              <div class="card-body d-flex flex-row justify-content-between" style="padding-bottom: .6rem;">
                ...
                <div class="card-right">
                  <div style="font-size: 1.8rem;font-weight: 700; color: #244785;"><span id="i_count"></span></div>
                </div>
              </div>
            </div>
            <div class="card mb-3">
              <div class="card-body d-flex flex-row justify-content-between" style="padding-bottom: .6rem;">
                ...
                <div class="card-right">
                  <div style="font-size: 1.8rem;font-weight: 700;color: #F7B924;"><span id="p_count"></span></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body">
            ...
            <div class="row space-5">
              <div class="col-sm-12 col-md-12" style="height: 20px;">
                ...
                <span id="checkout_total" style="color: black;"><b></b></span>
              </div>
              <div class="col-6 col-sm-6 col-md-6">
                <div>
                  <small class="text-muted">bu gün giriş</small>
                  <br>
                  <span id="checkout_today_in" class="ff-2 fs-14 bold" style="color: black;"><b> </b></span>
                </div>
              </div>
              <div class="col-6 col-sm-6 col-md-6">
                <div>
                  ...
                  <br>
                  <span id="checkout_today_out" class="ff-2 fs-14 bold" style="color: black;"><b> </b></span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="main-card mb-3 card mainCart">
          ...
          <div class="table-responsive">
            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
              ...
              <tbody id="tBodyProductDashBoard">
      ...
      <div class="col-sm-6">
        <div class="main-card mb-3 card"
          ...
          <div class="card-header"
               style="text-transform: uppercase;color: rgba(25,38,69,0.7);font-weight: 700; font-size: 0.88rem;">Son Ödenen Fişler</div>
          <div class="table-responsive">
            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
              <thead>
              <tr>
