...
<nav id="sidebar" class="active">
    ...
    <ul class="list-unstyled components mb-5">
        ...
        <li class="<%=pagex.contains("order") ? "active": "" %>">
            <a href="order.jsp"><span class="fa fa-shopping-cart"></span>
                <div class="menu_div">Siparişler</div>
            </a>
        </li>
        <li class="<%=pagex.contains("checkout") || pagex.contains("payIn")  || pagex.contains("payOut") ? "active": "" %>">
            <a href="checkout.jsp"><span class="fa fa-window-maximize"></span>
                <div class="menu_div">Kasa Yönetimi</div>
            </a>
        </li>
        <li>
            <a href="admin-logout"><span class="fa fa-lock"></span>
